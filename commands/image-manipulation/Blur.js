...
module.exports = class extends bot {
        ...
        this._run = async () => {
            try {
                ...
                function sendBuffer(err, buff){
                    message.channel.send(langset[lang.lang || 'en'].REQUESTED_BY.replace(/\[USER\]/g, message.author.tag),new Discord.Attachment(buff, "blur.png")).catch(console.error);
                }
            } catch (e) {
            }
        }
    ...
    run() {
        if (this.commands["image-manipulation"].blur.status) {
